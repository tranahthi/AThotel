          ...
          <div class="sub-room-service">
            ...
            <div class="svg-room-service">
              <ul class="list-tag-room">
                ...
                <div class="item-service">
                  <img
                    src="${singleRoomDetail.svg2}"
                    alt="Phục vụ đồ ăn tại phòng"
                  />
                  <p>Phục vụ đồ ăn tại phòng</p>
                </div>
              </li>
                <li class="sub-list-tag">
                  <div class="item-service">
                    <img
                      src="${singleRoomDetail.svg3}"
                      alt="Bồn tắm hoa sen"
                    />
                    <p>Bồn tắm hoa sen</p>
                  </div>
                ...
                <li class="sub-list-tag">
                  <div class="item-service">
                    <img
                      src="${singleRoomDetail.svg4}"
                      alt="Internet không dây"
                    />
                    <p>Internet không dây</p>
                  </div>
                </li>
              </ul>
            </div>
    ...
    <div class="form-main">
      <form id="booking-form" class="booking-form">
        ...
        <table class="table-form">
          ...
          <tr>
            <td>
              <button type="button" class="button-temp" id="btnTemp">
                <p>Tạm tính</p>
              </button>
            </td>
            <td>
...
function renderDoubleRoomDetail(doubleRoomDetail) {
  ...
  <div class="ul-main">
    <ul class="bread-crumb">
      ...
      <li>
        <div class="home-main-svg">
          <a href="phongdoi.html">Phòng đôi</a>
          <span class="svg-svg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <li>
        <div>
          <a class="title-a" href="">${doubleRoomDetail.name}</a>
        </div>
      </li>
    </ul>
  </div>
...
<div class="title-form-main">
  <div class="title-main">
    <div class="sub-title-main">
      <h3>${doubleRoomDetail.name}</h3>
      <div class="tag-info-room">
        <div class="item-tag-info">
          <img src="./assets/img/tag_people.webp" alt="số người" />
          <p>${doubleRoomDetail.guest}người lớn</p>
        </div>
        <div class="item-tag-info">
          <img src="./assets/img/tag_people.webp" alt="số người" />
          <p>${doubleRoomDetail.child} trẻ em</p>
        </div>
        <div class="item-tag-info">
          <img src="./assets/img/tag_size.webp" alt="diện tích phòng" />
          <p>Phòng ${doubleRoomDetail.area}m²</p>
        </div>
      </div>
          ...
          <div class="svg-room-service">
            <ul class="list-tag-room">
              ...
              <li class="sub-list-tag">
                <div class="item-service">
                  <img
                    src="${doubleRoomDetail.svg3}"
                    alt="Nấu ăn tại phòng"
                  />
                    <p>Nấu ăn tại phòng</p>
                </div>
              </li>
              <li class="sub-list-tag">
                <div class="item-service">
                  <img
                    src="${doubleRoomDetail.svg4}"
                    alt="Bồn tắm hoa sen"
                  />
                  <p>Bồn tắm hoa sen</p>
                </div>
  ...
  <div class="form-main">
    <form id="booking-form" class="booking-form">
      <span id="price" class="price product-price">${doubleRoomDetail.price.toLocaleString("vi-VN", {
      style: "currency",
      currency: "VND",
  })}/đêm</span>
      <table class="table-form">
