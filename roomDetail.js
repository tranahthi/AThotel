...
const areaP = document.querySelector('.area-p')
...
function renderSingleRoomDetail(singleRoomDetail) {
    ...
    areaP.innerHTML = `Phòng ${singleRoomDetail.area}m²` 
    priceProduct.innerHTML = `${singleRoomDetail.price.toLocaleString("vi-VN", {
      style: "currency",
      currency: "VND",
  })}/Đêm`
